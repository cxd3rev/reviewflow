  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-4 pb-20 pt-16 md:px-6 md:pt-24 lg:grid-cols-2 lg:gap-16 lg:pb-28">
        <div>
          <p className="text-sm font-medium tracking-wide text-zinc-400">starywrld</p>
          ...
          <p className="mt-6 max-w-md text-lg leading-8 text-zinc-400 md:text-xl">
            Automatische reviewverzoeken na afronding.
          </p>
          ...
          <p className="mt-4 text-sm text-zinc-500">7 dagen gratis. Daarna {PRICE_PER_MONTH}.</p>
        </div>
        <ProductMock />
      </div>
    </section>
